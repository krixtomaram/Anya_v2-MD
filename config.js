...
global.botname = process.env.BotName || "𝚇𝙸𝙽𝚇𝙾" 
global.author = process.env.Author || "@𝙺𝚁𝙸𝚇𝚃𝙾𝙼" 
global.packname = process.env.PackName || "꧁༺𝙺𝚁𝙸𝚇𝚃𝙾𝙼༻꧂" 
global.myweb = process.env.Web || "https://github.com/PikaBotz" 
global.footer = process.env.Footer || "© KING XINXO FIRE" 
global.prefa = process.env.Prefix || ['-'] 
global.themeemoji = process.env.ThemeEmoji || "🎐" 
global.ownername = process.env.Owner_Name || "KRIXTOM" 
global.ownernumber = process.env.Owner_Number || "919365354223" 
...
module.exports = {
  botname: process.env.BotName || "𝚇𝙸𝙽𝚇𝙾", 
  author: process.env.Author || "@KRIXTOM",
  packname: process.env.PackName || "꧁༺𝙺𝚁𝙸𝚇𝚃𝙾𝙼༻꧂",
  myweb: process.env.Web || "https://github.com/PikaBotz",
  footer: process.env.Footer || "© Queen Anya Bot",
  prefa: process.env.Prefix || ['-'],
  themeemoji: process.env.ThemeEmoji || "🎐",
  ownername: process.env.Owner_Name || "꧁༺𝙺𝚁𝙸𝚇𝚃𝙾𝙼༻꧂",
  ownernumber: process.env.Owner_Number || "919365354223",
  ...
  sessionId: process.env.SESSION_ID || "WUFXc0h_Queen-Anya_SVUg=", 
